                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php 
                            ...
                            //busca de quantidade de itens na tabela de sub-categorias, trazendo a quantidade correta
                        ...
                        <tr>
                            <td><?php if(@$imagem != ""){ ?>
                                    <img src="../../img/categories/<?php echo $imagem ?>" width="50">
                                <?php  }else{ ?>
                ...
                <div class="modal-body">
                    ...
                    <?php if(@$imagem2 != ""){ ?>
                    	<div class=" row dflex justify-content-center aling-item-center">
                            <img src="../../img/categories/<?php echo $imagem2 ?>" width="250" id="target"></div>
                 	<?php  }else{ ?>
